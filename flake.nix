  ...
  outputs = { self, nixpkgs }:
    let
      ...
      tomlHeader = pkgs.fetchurl {
        url =
          "https://raw.githubusercontent.com/marzer/tomlplusplus/30172438cee64926dc41fdd9c11fb3ba5b2ba9de/toml.hpp";
        sha256 =
          "0gkq35449zid4gx2lnqy2cs252m3lwgih6drczn9llfn9nnp4lbb"; # Run `nix-prefetch-url <url>` to get the hash
      };
      ...
      evdev-keymapper-service = { config, lib, pkgs, ... }:
        let
    ...
    in {
      ...
      devShells.${system}.default = pkgs.mkShell {
        packages = [ pkgs.gnumake pkgs.fd pkgs.linuxHeaders ];
        shellHook = ''
